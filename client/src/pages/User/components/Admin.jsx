...
import { fetchAllBusinesses, softDeleteBusiness, softRestoreBusiness } from '../../../services/admin'; // Import service functions
              ...
              <div className="col-md-4 mb-4" key={business.id}>
                <div className="card" style={{ width: '100%', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.2)', opacity: business.isBlocked ? 0.5 : 1 }}>
                  ...
                  <div className="card-body">
                    <h5 className="card-title" style={{ color: '#495057' }}>{business.name}</h5>
