        ...
        <ul className="nav flex-column">
          <li className="nav-item mb-2">
            <Link
              to="#"
              onClick={() => {
                setActiveLink("Deals and Offers");
                onNavItemClick("DealsOffers");
              }}
              className={`nav-link ${
                activeLink == "Deals and Offers" ? "active" : ""
              }`}
            >
          ...
          <li className="nav-item mb-2">
            <Link
              to="#"
              onClick={() => {
                setActiveLink("Latest Products");
                onNavItemClick("LatestProducts");
              }}
              className={`nav-link ${
                activeLink == "Latest Products" ? "active" : ""
              }`}
            >
          ...
          <li className="nav-item mb-2">
            <Link
              to="#"
              onClick={() => {
                setActiveLink("Latest Services");
                onNavItemClick("LatestServices");
              }}
              className={`nav-link ${
                activeLink == "Latest Services" ? "active" : ""
              }`}
            >
          ...
          <li className="nav-item mb-2">
            <Link
              to="#"
              onClick={() => {
                setActiveLink("Most Preferred Products");
                onNavItemClick("MostPreferredProducts");
              }}
              className={`nav-link ${
                activeLink == "Most Preferred Products" ? "active" : ""
              }`}
            >
          ...
          <li className="nav-item mb-2">
            <Link
              to="#"
              onClick={() => {
                setActiveLink("Most Preferred Services");
                onNavItemClick("MostPreferredServices");
              }}
              className={`nav-link ${
                activeLink == "Most Preferred Services" ? "active" : ""
              }`}
            >
